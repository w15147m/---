export const TAQEEBAT_GROUPS = [
  { id: 'specific', arabicName: 'دعا بعد از نماز', englishName: 'Specific' },
  { id: 'general', arabicName: 'دیگر دعائیں', englishName: 'Other' },
];

export const TAQEEBAT_DATA = {
  specific: [
    { 
      id: 1, 
      englishName: 'Fajr Prayer', 
      type: 'DAWNING', 
      detail: 'PAGE 09', 
      arabicName: 'دعائے  نمازِ فجر',
    ...
    { 
      id: 2, 
      englishName: 'Dhuhr Prayer', 
      type: 'NOON', 
      detail: 'PAGE 11', 
      arabicName: 'دعائے  نمازِ ظہر',
    ...
    { 
      id: 3, 
      englishName: 'Asr Prayer', 
      type: 'AFTERNOON', 
      detail: 'PAGE 12', 
      arabicName: 'دعائے  نمازِ عصر',
      text: 'اَسْتَغْفِرُ اللهَ الَّذِی لَا اِلٰهَ اِلَّا هُوَ الْحَیُّ الْقَیُّومُ الرَّحْمٰنُ الرَّحِیمُ ذُوالْجَلَالِ وَالْاِكْرَامِ وَ اَسْئَلُهٗ اَنْ یَّتُوبَ عَلَیَّ تَوْبَةَ عَبْدٍ ذَلِیلٍ خَاضِعٍ فَقِیرٍ بَائِسٍ مِسْکِینٍ مُسْتَکِینٍ مُسْتَجِیرٍ لَا یَمْلِكُ لِنَفْسِهٖ نَفْعًا وَّلَا ضَرًّا وَّلَا مَوْتًا وَّلَا حَیَاةً وَّلَا نُشُورًا. اَللّٰهُمَّ اِنِّی اَعُوذُ بِكَ مِنْ nَفْسٍ لَّا تَشْبَعُ وَ مِنْ قَلْبٍ لَّا یَخْشَعُ وَ مِنْ عِلْمٍ لَّا یَنْفَعُ وَ مِنْ صَلٰوةٍ لَا تُرْفَعُ وَ مِنْ دُعَاءٍ لَا یُسْمَعُ اَللّٰهُمَّ اِنِّی اَسْئَلُكَ الْیُسْرَ بَعْدَ الْعُسْرِ وَالْفَرَجَ بَعْدَ الْکَرْبِ وَ الرَّخَاءَ بَعْدَ الشِّدَّةِ اَللّٰهُمَّ مَا بِنَا مِنْ نِّعْمَةٍ فَمِنْكَ لَا اِلٰهَ اِلَّا اَنْتَ اَسْتَغْفِرُكَ وَ اَتُوبُ اِلَیْكَ.'
    },
    { 
      id: 4, 
      englishName: 'Maghrib Prayer', 
      type: 'EVENING', 
      detail: 'PAGE 13', 
      arabicName: 'دعائے  نمازِ مغرب',
    ...
    { 
      id: 5, 
      englishName: 'Isha Prayer', 
      type: 'NIGHT', 
      detail: 'PAGE 14', 
      arabicName: 'دعائے  نمازِ عشاء' 
    },
  ],
  general: [
    { 
    ...
    { 
      id: 6, 
      englishName: 'Dua Imam Zamana', 
      type: 'DEVOTIONAL', 
      detail: 'SPECIAL', 
      arabicName: 'دعا برائے امامِ زمانہ',
...
export const getTaqeebatData = (groupId) => {
  return TAQEEBAT_DATA[groupId] || [];
};

export const getTaqeebatGroups = () => {
  return TAQEEBAT_GROUPS;
};
