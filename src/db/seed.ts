...
export const seedDatabase = async () => {
  try {
    // Check if we already have Isha Prayer (to avoid redundant seeding)
    const { eq } = require('drizzle-orm');
    const existingIsha = await db.select().from(articles)
      .where(eq(articles.title_en, 'Isha Prayer'))
      .limit(1);

    if (existingIsha.length > 0) {
      console.log('🌱 Isha Prayer already exists in database, skipping seed...');
      return;
    }

    console.log('🌱 Seeding missing Taqeebat (Isha Prayer)...');
    ...
    if (specificSub) {
      const specificPrayers = [
        ...
        {
          title_ar: 'دعائے  نمازِ عشاء', title_en: 'Isha Prayer',
          text: 'اَللّٰھُمَّ اِنَّہٗ لَیْسَ لِیْ عِلْمٌ بِمَوْضِعِ رِزْقِیْ وَ اِنَّمَا اَطْلُبُہٗ بِخَطَرَاتٍ تَخْطُرُ عَلٰی قَلْبِیْ فَاَجُوْلُ فِیْ طَلَبِہِ الْبُلْدَانَ فَاَنَا فِیْمَا اَنَا طَالِبٌ کَالْحَیْرَانِ لَا اَدْرِیْ اَفِیْ سَہْلٍ ھُوَ اَمْ فِیْ جَبَلٍ اَمْ فِیْ اَرْضٍ اَمْ فِیْ سَمَآءٍ اَمْ فِیْ بَرٍّ اَمْ فِیْ بَحْرٍ وَ عَلٰی یَدَیْ مَنْ وَ مِنْ قِبَلِ مَنْ وَ قَدْ عَلِمْتُ اَنَّ عِلْمَہٗ عِنْدَکَ وَ اَسْبَابَہٗ بِیَدِکَ وَ اَنْتَ الَّذِیْ تَقْسِمُہٗ بِلُطْفِکَ وَ تُسَبِّبُہٗ بِرَحْمَتِکَ اَللّٰھُمَّ فَصَلِّ عَلٰی مُحَمَّدٍ وَّ آلِ مُحَمّدٍ وَاجْعَلْ یَا رَبِّ رِزْقَکَ لِیْ وَاسِعاً وَّ مَطْلَبَہٗ سَہْلاً وَّ مَاْخَذَہٗ قَرِیْباً وَ لَا تُعَنِّنِیْ بِطَلَبِ مَا لَمْ تُقَدِّرْ لِیْ فِیْہِ رِزْقاً فَاِنَّکَ غَنِیٌّ عَنْ عَذَابِیْ وَ اَنَا فَقِیْرٌ اِلٰی رَحْمَتِکَ فَصَلِّ عَلٰی مُحَمَّدٍ وَّ آلِہٖ وَ جُدْ عَلٰی عَبْدِکَ بِفَضْلِکَ اِنَّکَ ذُوْ فَضْلٍ عَظِیْمٍ.'
        }
      ];
