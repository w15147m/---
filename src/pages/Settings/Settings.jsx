          ...
          >
            ...
            <View className="bg-white dark:bg-slate-900 rounded-2xl p-5 shadow-sm border border-slate-100 dark:border-slate-800 mb-8">
              ...
              {fontSettings.map((setting, index) => (
                <View 
                  key={setting.key}
                  className={index < fontSettings.length - 1 ? 'mb-8 pb-8 border-b border-slate-50 dark:border-slate-800' : ''}
                >
                  {/* Header & Description */}
                  <View className="mb-4">
                  ...
                  <View className="flex-row justify-between mb-5">
                    ...
                    <Text className="text-xs font-bold text-indigo-600 dark:text-indigo-400">
                      {Math.round(setting.currentSize)}pt
                    </Text>
                    <Text className="text-[10px] text-slate-500 dark:text-slate-400">
                      Large ({setting.max})
                    </Text>
                  ...
                  <View className="items-center py-5 bg-slate-50 dark:bg-slate-800 rounded-xl">
                    <Text 
                      ...
                      style={{ 
                        ...
                        lineHeight: setting.currentSize * (setting.key === 'translationSize' ? 1.4 : 1.8)
                      }}
                    >
                      {setting.preview}
                    </Text>
